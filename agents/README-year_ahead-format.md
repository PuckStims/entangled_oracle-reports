...
- treat `Forecast Climate` as removed from the client report, not rescued by styling
- preserve technical scaffolding where it supports trust, but do not let it dominate the reading surface

Verification in this pass used fresh HTML/PDF generation plus regression tests for the client report render path.
