...
- **Grammar Substrate**: Use `products/location_services/evidence_grammar/` to compare normalized evidence items instead of inventing a parallel comparison-only evidence shape.
