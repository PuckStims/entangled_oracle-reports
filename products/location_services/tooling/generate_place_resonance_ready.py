#!/usr/bin/env python3
"""
Generate a Place Resonance HTML draft from birth data and one destination.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a Place Resonance HTML draft.")
    ...
    parser.add_argument("--purpose-lens", dest="purpose_lens", help="Optional Place Resonance purpose lens")
    parser.add_argument(
        "--relationship-to-place",
        dest="relationship_to_place",
        help="Optional relationship label such as possible_move or current_home",
    )
...
def main() -> int:
    ...
    output_path = write_place_resonance_html(html, args.output_filename)
    print(output_path)
    return 0
