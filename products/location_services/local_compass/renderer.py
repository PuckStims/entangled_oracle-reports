"""
HTML rendering for the Local Compass draft report.
"""
...
TEMPLATE_NAME = "location_services/templates/local_compass.html"
RENDER_VERSION = "local_compass_render_v0.2.0"
...
def render_local_compass_html(place_context: dict) -> str:
    """
    Render a Local Compass context into HTML.
    """
...
def write_local_compass_html(html_str: str, filename: str | None = None) -> str:
    ...
    if not filename:
        ...
        filename = f"local_compass_{timestamp}.html"
