...
SPECIALIST_BODY_POLICIES = {
    "Chiron": {
        ...
        "eligible_report_types": ("soul_ecosystem", "asteroid_portrait", "predictive_sandbox"),
    ...
    "Lilith_BML": {
        ...
        "method_name": "specialist_body_context",
        "eligible_report_types": ("soul_ecosystem", "asteroid_portrait", "predictive_sandbox", "year_ahead", "personal_forecast"),
